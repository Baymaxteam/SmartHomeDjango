...
def schedulesTask(commd, Type, address):
	if noSerialPortMode == False:
		...
		print('schedulesTask({0},{1},{2})'.format(commd, Type, address))
	else:
		print('<In noSerialPortMode> schedulesTask({0},{1},{2})'.format(commd, Type, address))
...
def PcomdRouting():
	if noSerialPortMode == False:
		...
		print('<In noSerialPortMode> PcomdRouting...')
